...
public class Event {
    ...
    public static Event preorder(String title, String date, String color) {
        return new Event()
                .setTitle(PRE_ORDER + title.toUpperCase())
                .setStart(date)
                .setColor(color);
    }

    public static Event release(String title, String date, String color) {
        return new Event()
                .setTitle(RELEASE + title.toUpperCase())
                .setStart(date)
                .setColor(color);
    }
